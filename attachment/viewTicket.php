<?php
    ...
    $ticketID = $conn->real_escape_string(filter_input(INPUT_GET,'id'));
    if (filter_input(INPUT_SERVER,'isAdmin')){
	...
	if (isset(filter_input(INPUT_POST,'saveReply'))) {
		$reply = $conn->real_escape_string(nl2br(filter_input(INPUT_POST,'reply')));
